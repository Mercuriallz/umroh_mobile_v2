...
import 'package:mobile_umroh_v2/model/auth/login/area-manager/area_manager_model.dart';
import 'package:mobile_umroh_v2/model/auth/login/area-manager/area_manager_request_model.dart';
import 'package:mobile_umroh_v2/model/auth/login/chief/login_chief_model.dart';
import 'package:mobile_umroh_v2/model/auth/login/chief/login_chief_request_model.dart';
import 'package:mobile_umroh_v2/model/auth/login/jemaah/login_model.dart';
import 'package:mobile_umroh_v2/model/auth/login/jemaah/login_request_model.dart';
import 'package:mobile_umroh_v2/model/auth/login/regional-manager/regional_manager_model.dart';
...
class LoginBloc extends Cubit<LoginState> {
  ...
  Future<void> loginAreaManager({LoginAreaManagerRequestModel? formData}) async {
    if (formData == null) {
      emit(LoginError("Data login tidak boleh kosong"));
      return;
    }
  ...
  Future<void> loginRegionalManager({LoginRegionalManagerRequestModel? formData}) async {
    if (formData == null) {
      emit(LoginError("Data login tidak boleh kosong"));
      return;
    }
