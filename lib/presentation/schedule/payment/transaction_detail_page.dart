...
class TransactionDetailPage extends StatefulWidget {
  ...
  final String? targetCompleted;
  final String? percentage;
  const TransactionDetailPage({super.key, required this.trx, this.totalPayment, this.targetCompleted, this.percentage});
        ...
        child: SingleChildScrollView(
          ...
          child: BlocBuilder<TransactionDetailBloc, TransactionDetailState>(
            ...
            if (state is TransactionDetailLoading) {
              ...
              final transaction = state.transactionDetailModel;
              return Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                         Center(
                          child: Text(transaction.paketName!, style: TextStyle(fontSize: 14)),
                        ),
                         Center(
                          child: Text(
                            rupiahConverter.formatToRupiah(int.parse(widget.targetCompleted.toString())),
                            style: TextStyle(
                              fontSize: 20,
                        ...
                        Row(
                          ...
                          children:  [
                            ...
                            Text(rupiahConverter.formatToRupiah(int.parse(widget.totalPayment.toString())), style: TextStyle(color: Colors.black)),
                          ],
                        ),
