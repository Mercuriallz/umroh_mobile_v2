...
import 'package:mobile_umroh_v2/mitra_desa_&_jemaah/presentation/auth/register/register_page.dart';
  ...
  void _login() {
    if (formKey.currentState!.validate()) {
      if (selectedRole == 'Jemaah') {
        ...
        context
            .read<LoginBloc>()
            .loginAreaManager(formData: loginRequest);
        ...
        context
            .read<LoginBloc>()
            .loginRegionalManager(formData: loginRequest);
      } else {
        ...
        listener: (context, state) async {
          if (state is LoginLoading) {
            ...
            if (selectedRole == "Area Manager") {
              gets.Get.offAll(() => const AreaManagerHomePage());
            } else if (selectedRole == "Regional Manager") {
              gets.Get.offAll(() => const RegionalManagerHomePage());
            } else {
