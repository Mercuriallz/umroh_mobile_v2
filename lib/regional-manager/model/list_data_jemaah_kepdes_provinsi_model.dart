class ListDataJemaahKepdesProvinsiModel {
  int? status;
  bool? error;
  DataJemaahKepdesProvinsi? data;
  String? message;

  ListDataJemaahKepdesProvinsiModel(
      {this.status, this.error, this.data, this.message});

  ListDataJemaahKepdesProvinsiModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    error = json['error'];
    data = json['data'] != null ? DataJemaahKepdesProvinsi.fromJson(json['data']) : null;
...
class DataJemaahKepdesProvinsi {
  List<UserKepdes>? userKepdes;
  List<UserJemaah>? userJemaah;
  int? totalJemaah;

  DataJemaahKepdesProvinsi({this.userKepdes, this.userJemaah, this.totalJemaah});

  DataJemaahKepdesProvinsi.fromJson(Map<String, dynamic> json) {
